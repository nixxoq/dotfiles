...
static const Rule rules[] = {
	...
	RULE(.class = "64Gram", .isfloating = 0)
	RULE(.class = "TelegramDesktop", .isfloating = 0)
};
...
static const char *brupcmd[] = { "change-brightness", "up", NULL };
static const char *brdowncmd[] = { "change-brightness", "down", NULL };
...
static const Key keys[] = {
	...
	{ 0,                            XF86XK_AudioLowerVolume,    spawn,          SHCMD("pactl set-sink-volume 0 -3%") },
  	...
  	{ ShiftMask|Mod4Mask,		XK_s,                       spawn,          {.v = flameshot} },
